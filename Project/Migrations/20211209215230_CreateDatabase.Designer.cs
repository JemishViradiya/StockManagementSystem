...
namespace Project.Migrations
{
    ...
    [Migration("20211209215230_CreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment.Models.Address", b =>
                {
                    b.HasOne("Assignment.Models.Customer", "customer")
                        .WithOne("address")
                        .HasForeignKey("Assignment.Models.Address", "customerId")
            ...
            modelBuilder.Entity("Project.Models.Stock", b =>
                {
                    b.HasOne("Assignment.Models.Customer", null)
                        .WithMany("stocks")
                        .HasForeignKey("customer_id");

                    b.HasOne("Project.Models.Fevourite", null)
                        .WithMany("stocklist")
                        .HasForeignKey("fevourite_id");
                });
